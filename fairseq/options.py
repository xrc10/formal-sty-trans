...
def add_optimization_args(parser):
    ...
    group.add_argument('--pre-train-max-epoch', '--pmp', default=0, type=int, metavar='N',
                       help='force stop pre-training at specified epoch')
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--restore-best', default=False, action='store_true',
                       help='restore from the best checkpoints')
...
def add_generation_args(parser):
    ...
    group.add_argument('--oracle-score', default=False, action='store_true',
                       help='to use oracle to score output in nbest')
    group.add_argument('--disc-score', default=False, action='store_true',
                       help='to use discriminator to score output in nbest')
