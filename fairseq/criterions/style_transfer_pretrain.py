...
@register_criterion('style_transfer_pretrain')
class StyleTransferPretrainCriterion(FairseqCriterion):
    ...
    def aggregate_logging_outputs(logging_outputs):
        ...
        return {
            'loss': sum(log.get('mt_loss', 0) for log in logging_outputs) / sample_size / math.log(2),
