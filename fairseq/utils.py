...
def inc_weight(it, steps=3500, speed=1000):
    """
    Credit to: https://github.com/kefirski/pytorch_RVAE/
    0 -> 1
    """
    return (math.tanh((it - steps)/speed) + 1)/2


def anneal_temp(it, steps=10000, speed=10000):
    """
    Softmax temperature annealing
    1 -> 0
    """
    return 1-inc_weight(it, steps, speed) + 1e-3  # To avoid overflo
