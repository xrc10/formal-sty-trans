...
def get_parser():
    ...
    parser.add_argument('--plainpref', metavar='FP', default=None, help='comma separated, plain file prefixes')
...
def main(args):
    ...
    def make_all(lang):
        ...
        if args.plainpref:
            for k, plainpref in enumerate(args.plainpref.split(',')):
                outprefix = 'plain{}'.format(k) if k > 0 else 'plain'
                make_dataset(plainpref, outprefix, lang)
